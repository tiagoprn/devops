...
# e.g.
SYNTAX="./live-restore-vm.sh -x [XML_CONFIG] -n [VM_NAME] -i [QCOW2_IMAGE]"
HELP="./live-restore-vm.sh -x config.yml -n centos7-02 -i /kvm/images/centos.qcow2"
...
python change_kvm_config_to_restoration.py -x $XML_CONFIG -n $VM_NAME -i $QCOW2_IMAGE
