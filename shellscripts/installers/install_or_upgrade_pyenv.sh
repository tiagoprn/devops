...
if [ -f $PYENV_BIN ]; then
    ...
    echo -e "\t sudo apt install -y git build-essential python3-dev libssl-dev libbz2-dev libreadline-dev sqlite3 vim libsqlite3-dev libffi-dev liblzma-dev zlib1g-dev libncurses5-dev libncursesw5-dev"
